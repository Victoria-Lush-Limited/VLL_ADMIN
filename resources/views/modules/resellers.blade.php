...
<div class="legacy-box">
    <div class="legacy-title">Resellers</div>
    <form method="POST" action="{{ route('web.resellers.store') }}" class="row g-2 mb-3">
        @csrf
        <div class="col-md-3"><input class="form-control" name="name" placeholder="Reseller name" required></div>
