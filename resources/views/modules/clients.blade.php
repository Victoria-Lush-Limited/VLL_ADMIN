...
<div class="legacy-box">
    <div class="legacy-title">Clients</div>
    @if((auth()->user()->account_type ?? null) === 'administrator')
        <form method="POST" action="{{ route('web.clients.store') }}" class="row g-2 mb-3">
            @csrf
            <div class="col-md-3"><input class="form-control" name="name" placeholder="Client name" required></div>
